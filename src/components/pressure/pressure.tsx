  ...
  return (
    <>
      <div className="image-container">
        <div className="parallax-pressure"></div>
        <div className="pressure_heading">Pressure Washing</div>
        <h2 className="other-caption-commercial ">
          <span>
            We can leave your house looking spick and span.
          </span>
        </h2>
      </div>
        ...
        <div className="row align-items-stretch">
          ...
          <div className="col-lg-6">
            <div className="text-section-pressure">
              ...
              <p>
                Discover the rejuvenating prowess of professional pressure
                washing with Sucasa Paint and Roof. Dive into a realm where
                state-of-the-art technology meets unparalleled expertise, giving
                your property the radiant facelift it truly deserves. Our
                commitment to excellence transcends the typical, promising
                transformative results that redefine curb appeal and
            ...
            <div className="text-section-pressure">
              ...
              <p>
                Your property, be it residential or commercial, stands as an
                emblem of your attention to detail and care. At Sucasa Paint and
                Roof, we amplify this sentiment by stripping away years of dirt,
                grime, and environmental wear, unveiling an underlying sheen
                that speaks volumes. Harnessing top-grade equipment and
                environmentally-friendly solutions, our adept pressure washing
                team ensures your surfaces are not only sparkling clean but also
                treated with the utmost respect and care. Your satisfaction
                drives our mission, and we strive for impeccable results,
                revealing a property that gleams with pride.
              </p>
            </div>
            <div className="text-section-pressure">
              <h2>Revitalize, Protect, and Impress</h2>
              <p>
                At Sucasa Paint and Roof, our pressure washing services go
                beyond mere cleaning. We offer a trifecta of benefits:
                revitalizing your property's appearance, protecting surfaces
                from potential damage due to accumulated grime, and making a
                lasting impression on visitors, neighbors, and clients. Entrust
                us with your property, and witness a transformation that
                elevates its value and appeal.
              </p>
            </div>
            <Navigation
