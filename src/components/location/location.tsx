    ...
    <>
      <body>
        ...
        <div className="location-text">
          ...
          <h3>
            Don't see your area? Don't be discouraged and contact us anyways!
          </h3>
          <p>
            These are the main cities that we serve, but Sucasa Painting is
            happy to work on homes all throughout the Greater Seattle area.
